...
interface IBasePool {
    ...
    struct ClaimInfo {
        // Total repayments of all claimed loans
        uint256 repayments;
        // Total collateral of all claimed loans
        uint256 collateral;
        // Total original loan amount of all claimed loans
        uint256 loanAmount;
    }

    struct RewardRequest {
        // Account that performed the request
        address account;
        // Liquidity at the time of the request
        uint128 liquidity;
        // Time since last reward
        uint32 timeSinceLastReward;
    }
     ...
     * @return _rewardCoefficient Coefficient for LP rewards
